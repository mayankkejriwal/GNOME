...
def use_get_out_of_jail_card(player, current_gameboard):
    ...
    if player.has_get_out_of_jail_chance_card: # we give first preference to chance, then community chest
        ...
        current_gameboard['chance_cards'].add(copy.deepcopy(current_gameboard['chance_card_objects']['get_out_of_jail_free']))
        print 'Returning 1'
        return 1
        ...
        current_gameboard['community_chest_cards'].add(copy.deepcopy(current_gameboard['community_chest_card_objects']['get_out_of_jail_free']))
        print 'Returning 1'
        return 1
    else:
